...
const FavBook = () => {
  return (
    <div className='px-4 lg:px-24 my-20 flex flex-col md:flex-row justify-between items-center gap-12'>
      ...
      <p className='mb-10 text-lg md:w-5/6'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur perspiciatis sunt laboriosam eveniet rem doloremque repellat reprehenderit, maxime, voluptatem earum dolorum minus tempora quidem ratione adipisci rerum voluptates numquam ipsum!</p>
